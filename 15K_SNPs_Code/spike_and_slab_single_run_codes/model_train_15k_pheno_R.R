...
spike_slab_model_predict <- predict(spike_slab_model_R, df_test, burn = burn)

print("Saving the model outputs")
save(spike_slab_model_R, file=file)
